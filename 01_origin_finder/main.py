...
import time
from origin_finder import SkewAnalyzer, FrequentKmersWithMismatches
...
def main():
    ...
    kmers_finder = FrequentKmersWithMismatches()
    start_time = time.time()
    min_skew_pos = skew_analyzer.run(text)
    ...
    for start, end, window_name in windows:
        ...
        frequent_kmers = kmers_finder.run(window_seq, k, d)
